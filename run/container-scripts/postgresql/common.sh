...
echo generate_postgresql_config POSTGRESQL_CONFIG_FILE ${POSTGRESQL_CONFIG_FILE}
cat ${POSTGRESQL_CONFIG_FILE}
  ...
  (
  shopt -s nullglob
  echo generate_postgresql_config APP_DATA ${APP_DATA}
  ls" ${APP_DATA}"/src/postgresql-cfg/*.conf
