...
#RUN cd $APP_DATA/src && wget https://download.oracle.com/otn_software/linux/instantclient/1914000/instantclient-basic-linux.x64-19.14.0.0.0dbru.zip && \
...
#RUN yum -y remove gcc.x86_64 bison flex git wget make.x86_64 libxml2-devel openssl-devel zlib-devel.x86_64 readline-devel.x86_64
